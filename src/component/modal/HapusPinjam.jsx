...
import { deleteOnePinjam } from '../../redux/pinjam'
        ...
        return(
            <div className={props.active ? "bg-dark bg-opacity-50 wrap-modal" : "d-none"}>
                ...
                <div className="main-modal p-3 rounded" style={{ "width": "50vw", "max-height": "80vh", "backgroundColor": "white"}}>
                    ...
                    <p className="text-center">Pinjam {props.idPinjam}</p>
                    <button className="btn btn-danger mt-3 w-100" onClick={() => handleDelete(props.idPinjam)}>Delete</button>
                </div>
            </div>
        )
    }
